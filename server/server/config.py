...
class Settings(BaseSettings):
    ...
    memory_db_path: str = Field(default="server/data/memory.db", validation_alias="JARVIS_MEMORY_DB")
    ...
    memory_model: str = Field(default="claude-haiku-4-5-20251001", validation_alias="JARVIS_MEMORY_MODEL")
