...
- **Karoline Geiker (Legal/Regulatory Lead):** The team's missing piece. Karoline holds an LLM in Law and Technology (Tilburg University) and is completing a cand.jur. at the University of Copenhagen. She has hands-on EU legislative analysis experience — she analyzed EU proposals and MEP amendments at the European Central Securities Depositories Association (ECSDA) in Brussels and conducted jurisprudential research at the Institute for European Studies (VUB). Her role: (1) interpret the AI Act's provisions into precise, actionable compliance logic that Maxime can encode — risk classification rules, documentation requirements, conformity assessment checklists; (2) validate that the platform's automated risk classifications and generated documentation are legally sound; (3) monitor regulatory developments and guidance from national authorities post-enforcement to keep templates current; (4) build relationships with EU law firms for the partnership layer. She bridges the gap between the regulation's legal text and the product's technical implementation — without her, the team would be guessing at legal interpretation.
- **Fabio Cassisa (Creative Technology & AI Agent Lead):** Fabio is a design-to-technology hybrid currently working as an AI engineer/architect building complex agents at Adnami (ad tech), with a self-described "unicorn full-stack + design" profile. He brings three critical capabilities: (1) **AI agent architecture** — his current work building complex agents directly transfers to GuardRail's automated AI system detection and intelligent compliance workflows; (2) **full-stack creative development** — he bridges Maxime's backend/ML engineering and Harsh's UX design by implementing the front-end, building interactive compliance wizards, and ensuring the product feels as polished as it is technically sound; (3) **AI ethics domain knowledge** — his Malmö University coursework on AI Ethics, Regulation, and Politics (15 credits, grade B) gives him a working understanding of the regulatory landscape that most engineers lack, enabling productive collaboration with Karoline on translating legal requirements into product logic. His prior startup experience (co-founded 4Foodie, 2021-2023) means he understands the pace and constraints of building from zero. Based in the same Malmö/Copenhagen ecosystem as the rest of the team.
...
- **Competitive edge:** EU-based team of four (geographic trust + regulatory proximity), mid-market focus (enterprise competitors ignore this segment), self-serve UX (no mandatory sales calls), a Law & Technology specialist (Karoline) ensuring legal accuracy, and a dedicated AI agent architect (Fabio) who also brings AI ethics domain knowledge — most competing tools are built by pure-engineering teams guessing at regulation with no design or legal expertise.
...
**Why it wins:** The August 2026 deadline is a forcing function no other project has. 50,000+ mid-market European companies need compliance, no one serves them, and the team is now a four-person squad covering every critical discipline: Maxime (data/ML engineering), Harsh (UX/product design), Karoline Geiker (EU law and technology), and Fabio Cassisa (AI agent architecture + creative development + AI ethics). The $5.78B market at 45.3% CAGR is the fastest-growing category in all the research. Time pressure means customers will pay now, not "eventually." With Karoline's legal expertise the team doesn't need to outsource regulatory interpretation, and with Fabio's agent-building experience and full-stack skills the front-end and intelligent compliance workflows can be built in parallel with Maxime's backend — no blocking dependencies.
