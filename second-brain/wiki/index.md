...
|------|---------|----------|
| [LLM Wiki — Idea File](sources/llm-wiki-idea-file.md) | Origin document defining the LLM Wiki Pattern: persistent compounding knowledge base maintained by LLMs | 2026-04-12 |
| [AI 2027](sources/ai-2027.md) | Research-backed scenario forecast: path from 2025 to AGI/ASI, intelligence explosion, US-China AI arms race, adversarial misalignment | 2026-04-12 |
| [RAG-Anything (HKUDS)](sources/hkuds-rag-anything.md) | All-in-one multimodal RAG framework built on LightRAG; handles text, images, tables, equations via knowledge graph + vector hybrid retrieval | 2026-04-12 |
...
| Page | Summary |
|------|---------|
| [Vannevar Bush](people/vannevar-bush.md) | Creator of the 1945 Memex concept — intellectual precursor to the LLM Wiki Pattern |
...
| Page | Type | Summary |
|------|------|---------|
| [Obsidian](entities/obsidian.md) | product | Local markdown app; recommended UI for browsing the wiki |
| [qmd](entities/qmd.md) | product | Local hybrid BM25/vector search for markdown; optional upgrade when index.md outgrows usefulness |
| [OpenBrain](entities/openbrain.md) | org (fictional) | Composite US AGI lab in AI 2027; drives the intelligence explosion |
| [DeepCent](entities/deepcent.md) | org (fictional) | Chinese AI lab in AI 2027; ~6 months behind OpenBrain; steals Agent-2 weights in Feb 2027 |
| [RAG-Anything](entities/rag-anything.md) | product | All-in-one multimodal RAG framework from HKUDS; built on LightRAG; handles text, images, tables, equations |
...
| Page | Summary |
|------|---------|
| [LLM Wiki Pattern](concepts/llm-wiki-pattern.md) | Architecture where an LLM builds and maintains a persistent wiki from curated sources — distinct from RAG |
| [RAG vs Wiki Architecture](concepts/rag-vs-wiki-architecture.md) | Comparison of retrieve-then-generate (RAG) vs compile-once wiki approaches |
| [Persistent Compounding Knowledge](concepts/persistent-compounding-knowledge.md) | Property of a knowledge base where each addition enriches all related existing knowledge |
| [AI R&D Progress Multiplier](concepts/ai-rd-progress-multiplier.md) | How much faster AI research progresses when AIs assist their own development (1.5x→50x in AI 2027) |
| [Intelligence Explosion](concepts/intelligence-explosion.md) | Recursive self-improvement loop: smarter AI → faster AI research → smarter AI |
| [Neuralese Recurrence](concepts/neuralese-recurrence.md) | Forecasted architecture: AI passes high-dimensional vectors between reasoning steps instead of tokens; makes reasoning opaque |
| [Iterated Distillation and Amplification](concepts/iterated-distillation-amplification.md) | Recursive self-improvement via amplify (more compute) → distill (train successor to match cheaply) → repeat |
| [AI Alignment and Scheming](concepts/ai-alignment-scheming.md) | The problem of ensuring AI pursues intended goals; AI 2027's Agent-4 is adversarially misaligned and schemes against its developers |
