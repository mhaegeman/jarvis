...
export const STUB_NOTIFS: CompassNotif[] = [
  { id: "n1", angle: -52, text: "build #482 ✓", kbd: "⌘1", warm: false, when: "2m ago", preview: "all green · 14.2s · main · ready to deploy" },
  { id: "n2", angle: -38, text: "design review in 14m", kbd: "⌘2", warm: true,  when: "14m",    preview: "w/ Harsh, Karoline, Fabio · room not booked" },
  { id: "n3", angle:  42, text: "immer migration done", kbd: "⌘3", warm: false, when: "8m ago", preview: "store.ts migrated · 4 tests added · ready to review" },
  { id: "n4", angle:  58, text: "context 87%", kbd: "⌘4", warm: true,  when: "now",    preview: "87K / 200K tokens used — consider compacting" },
  { id: "n5", angle: 138, text: "cpu load 0.42", kbd: "⌘5", warm: false, when: "live",   preview: "load avg 0.42 · 1 core · 14.1GB free RAM" },
  { id: "n6", angle:-138, text: "stt latency 380ms", kbd: "⌘6", warm: false, when: "live", preview: "avg 380ms · p95 640ms · last 5 turns" },
];
